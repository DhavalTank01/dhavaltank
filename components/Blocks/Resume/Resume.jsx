            ...
            <Container>
                <div className={styles.content}>
                    <div className={styles.cardGroup} ref={cardGroup}>
                        <div className={`${styles.card} ${styles.cardV1}`}>
                            <div className={styles.cardInner}>
                                <div className={styles.cardTitle}>Dhaval Tank</div>
                                <div className={styles.cardDesc}>Frontend Developer</div>
                                <hr />
                                <p>I am Dhaval, a Frontend developer with over 2 years of professional experience.
                                    Successfully building user-friendly websites with ReactJS, NextJS & NodeJs. I pay attention
                                    to
                                ...
                                <p>
                                    Jr. Frontend Developer | TechCompose Solutions Pvt. Ltd. <br />
                                    ReactJs Intern | TechCompose Solutions Pvt. Ltd. <br />
                                </p>
                            </div>
                    ...
                    <div className={styles.links}>
                        ...
                        <Link href={`${commonConfig.social.phone}`} target={'_blank'}>Phone</Link>
                        <Link href={`${commonConfig.social.email}`} target={'_blank'}>Email</Link>
                        <Link href={`${commonConfig.social.whatsapp}`} target={'_blank'}>Whatsapp</Link>
                    </div>
                </div>
            </Container>
        </section>
